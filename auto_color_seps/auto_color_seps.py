...
def auto_color_seps(image, drawable, resolution, location, center_offset, vert_offset, print_width, print_height, generate_ub, ub_threshold, font, font_size, label_spacing, export, do_color_match):
